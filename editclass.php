<?php
    ...
    $query = "SELECT * FROM classcomments WHERE commentid = :commentid";
    ...
    //This section is to insert, update, and delete comments
	...
	if ($_POST) {
		if ($_POST['command'] == 'Update') {
			$query = "UPDATE classcomments SET content = :content WHERE commentid = :commentid";	
		...
		if ($_POST['command'] == 'Delete') {
			$query = "DELETE FROM classcomments WHERE commentid = :commentid";
